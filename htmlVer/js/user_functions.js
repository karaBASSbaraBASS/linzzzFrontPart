...
(FormValidator = {
	...
	checkEmail : function (field)
	{
		...
		// var patternEmail = /^[^\x21-\x2f\x3a-\x40\x5b-\x60\x7b-\x7e][a-zA-Z0-9\-\_\.\+]+@[a-zA-Z0-9\-\_]+\.([a-zA-Z][\.]{0,1}){2,10}$/;
        ...
        var testMailMatch = inputValue.match(patternEmail);

        console.log(testEmail);
        console.log(testMailMatch);
...
function switchMobileBg(block, innerWidth) {
    ...
    if (typeof imageBlock.attr('data-mobile-img') === 'undefined') {
        return false;
    }
